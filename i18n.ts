...
const STRINGS: Record<Locale, Record<string, string>> = {
  ...
  zh: {
    ...
    'dialog.conflictFolder': "文件夹 {name} 已存在",
    'dialog.overwrite': '覆盖',
    'dialog.rename': '重命名',
    'dialog.cancel': '取消',
  },
  ...
  en: {
    ...
    'dialog.conflictFolder': "Folder \"{name}\" already exists",
  ...
  ja: {
    ...
    'dialog.conflictFolder': "フォルダ「{name}」は既に存在します",
  ...
  ko: {
    ...
    'dialog.conflictFolder': "폴더 \"{name}\"이(가) 이미 존재합니다",
  ...
  de: {
    ...
    'dialog.conflictFolder': "Ordner \u201e{name}\u201c existiert bereits",
  ...
  fr: {
    ...
    'dialog.conflictFolder': "Le dossier \u00ab {name} \u00bb existe d\u00e9j\u00e0",
  ...
  es: {
    ...
    'dialog.conflictFolder': "La carpeta \"{name}\" ya existe",
  ...
  pt: {
    ...
    'dialog.conflictFolder': "A pasta \"{name}\" j\u00e1 existe",
  ...
  it: {
    ...
    'dialog.conflictFolder': "La cartella \"{name}\" esiste gi\u00e0",
  ...
  th: {
    ...
    'dialog.conflictFolder': "โฟลเดอร์ \"{name}\" มีอยู่แล้ว",
  ...
  vi: {
    ...
    'dialog.conflictFolder': "Th\u01b0 m\u1ee5c \"{name}\" \u0111\u00e3 t\u1ed3n t\u1ea1i",
